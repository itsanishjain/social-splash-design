      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          >
            <Button
              variant="outline"
              className="manga-button bg-[#FFD700] hover:bg-[#FFD700] text-black border-black"
            >
        ...
        >
          <nav className="flex flex-col gap-4 manga-panel-small p-4">
            <div className="flex flex-col gap-2 mt-2">
              <Button
                variant="outline"
                className="manga-button bg-[#FFD700] hover:bg-[#FFD700] text-black w-full justify-center border-black"
              >
                <span className="text-black">
                  <Link to="/feed">Login</Link>
                </span>
