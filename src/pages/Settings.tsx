        ...
        <div className="manga-panel w-full p-4 md:p-6 max-w-4xl mx-auto dark:border-gray-700 dark:bg-gray-800">
          <div className="mb-6">
            ...
            <p className="font-['Comic_Neue'] text-gray-700 dark:text-gray-300 text-lg">
              Customize your MangaVerse experience!
            </p>
          </div>
            ...
            >
              <div className="grid gap-6">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <Button
                    variant="outline"
                    className="manga-button bg-white hover:bg-white border-black text-black dark:bg-gray-700 dark:text-white dark:border-gray-600"
                  >
                    Change Password
                  </Button>
                </div>
            ...
            >
              <div className="space-y-4">
                    ...
                    <PopoverContent className="border-2 border-black">
                      <div className="grid gap-4">
                        <div className="space-y-2">
                          <h4 className="font-medium leading-none font-['Bangers']">
                            Tag Settings
                          </h4>
                          <p className="text-sm text-gray-500 font-['Comic_Neue']">
                        ...
                        <div className="grid gap-2">
                          <div className="flex items-center">
                            <Checkbox
                              id="allow-everyone"
                              className="border-2 border-black mr-2 data-[state=checked]:bg-[#14B8A6]"
                              defaultChecked
                            />
                            <label
                ...
                <div>
                  <Button
                    variant="outline"
                    className="w-full manga-button border-2 border-black bg-white text-[#FF3860] hover:bg-white"
                  >
            ...
            >
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    variant="outline"
                    className="manga-button border-black bg-white hover:bg-white font-['Comic_Neue']"
                  >
                    Terms of Service
                  </Button>
                  <Button
