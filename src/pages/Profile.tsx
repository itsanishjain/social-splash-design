          ...
          {currentUser && (
            <div>
              ...
              <div className="px-6 mt-4">
                <h1 className="text-2xl font-bold font-['Bangers']">{currentUser.name}</h1>
                <p className="text-gray-600 mb-2">@{currentUser.username}</p>
                <p className="mb-4 font-['Comic_Neue']">Manga enthusiast | Digital artist | Cat lover 🐱 | Joined April 2023</p>
                
                <div className="flex gap-4 mb-6">
                  <div className="font-bold">
                    <span className="mr-1">423</span>
                    <span className="text-gray-600">Following</span>
                  </div>
                  <div className="font-bold">
                    <span className="mr-1">1.2K</span>
                    <span className="text-gray-600">Followers</span>
                  </div>
                </div>
                
                <div className="mb-6">
                  <Badge className="bg-[#FF3860] mr-2 border-2 border-black">Otaku Level 9000</Badge>
                  <Badge className="bg-[#00A7E1] mr-2 border-2 border-black">Verified Artist</Badge>
                  <Badge className="bg-[#FFD700] border-2 border-black">Premium Member</Badge>
                </div>
              </div>
                  ...
                  {userPosts.length > 0 ? (
                    ...
                    <Card className="border-4 border-dashed border-gray-300 bg-white">
                      <CardContent className="p-8 text-center">
                        <p className="text-xl font-['Bangers'] mb-4">No posts yet!</p>
                        <p className="font-['Comic_Neue'] mb-6">Share your first adventure with the community!</p>
                ...
                <TabsContent value="media" className="mt-4">
                  <div className="grid grid-cols-3 gap-2">
                    {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((item) => (
                      <div key={item} className="aspect-square bg-gray-200 rounded-lg border-2 border-black overflow-hidden">
                        <img 
